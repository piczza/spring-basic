...
public class MemberController {
    ...
    @GetMapping("/members")
    public String list (Model model){ //controller는 model을 통해 정보를 가져옴
        List<Member> members = memberService.findMembers();
        //model.addAttribute(String name, Object value) value 객체를 name의 이름으로 추가함.
        //view코드에선 name의 이름으로 value를 사용.
